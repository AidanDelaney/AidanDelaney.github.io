...
%.html: %.md
	...
	pandoc -s -t revealjs -A js/keybindings.js --section-divs -c css/vmg.css -c reveal.js/css/theme/white.css --variable transition="linear" --variable theme="white" --toc --toc-depth=1 --mathjax=js/Mathjax/MathJax.js?config=TeX-AMS_HTML-full $< -o $@ --bibliography bibliography.bib
